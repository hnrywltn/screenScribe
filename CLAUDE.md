...
- **Not built**: password reset/forgot-password, email verification, rate limiting on login attempts.
...
- `users` — `email` (unique), `password_hash`, `created_at`. Real email+password auth — see "Decided: auth mechanism".
